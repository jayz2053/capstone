...
def add_course():
	...
	r = requests.post('http://188.166.97.39:8080/course', json = payload)
...
def add_teaches():
	...
	r = requests.post('http://188.166.97.39:8080/teaches', json = payload)
...
def add_destination():
	...
	r = requests.post('http://188.166.97.39:8080/destination', json = payload)
